    ...
    <style>
        ...
        * {
        ...
        h1 {
            ...
            font-size: 28vw;
            line-height: 1;
            text-shadow: -2px .05em 0 rgba(0, 0, 0, .5);
        }
...
<body>
    <main class="page fade-in">
        <div id="top-bar" class="top-bar">
            <span class="action-btn action-btn_primary"><a href="/home">&larr; back home</a></span>
    ...
    <script>
        ...
        function init() {
            ...
            function Bug(x1, y1, x2, y2) {
                ...
                this.deg = function() {
                    return ((Math.atan((this.y2 - this.y1) / (this.x2 - this.x1))) + ((this.x2 - this.x1) / Math.abs(this.x2 - this.x1)) * Math.PI / 2) * 180 / Math.PI;
                };
                this.t = function() {
                    return (Math.sqrt(Math.pow(this.x2 - this.x1, 2) + Math.pow(this.y2 - this.y1, 2)) / this.v);
                };
            }
            ...
            Bug.prototype.crawl = function() {
                ...
                this.timeoutID = setTimeout(function() {
                    that.update()
                }, 1000 * (that.t() + that.delay)); // Time in ms
                // Move the bug around
            ...
            function getRandomPoints() {
                ...
                var bounds = [
                    [Math.random() * xMax, -bugSize],
                    [-bugSize, Math.random() * yMax],
                    [Math.random() * xMax, yMax],
                    [xMax, Math.random() * yMax]
                ];
